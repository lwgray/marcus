...
Default for 0.3.6.post1+ is ON — opt-out via canonical falsy values
for users who need the pre-#449 legacy decomposer behavior (debugging,
LLM-cost-sensitive runs, etc.).
"""
