...
class TestMetricsCollector:
    ...
    def __init__(self, metrics_file: str = "tests/test_metrics.json"):
        ...
        self.current_metrics: List[TestExecutionMetrics] = []
...
class PerformanceBaseline:
    ...
    def set_baseline(self, test_name: str, metric_name: str, value: float, 
                    tolerance: float = 0.2):
    ...
    def check_baseline(self, test_name: str, metric_name: str, current_value: float) -> Dict[str, Any]:
...
flaky_handler = FlakyTestHandler()
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if baseline_result['status'] == 'fail':
                    ...
                    # Set new baseline
                    baseline_manager.set_baseline(test_name, baseline_metric, execution_time, tolerance)
                    print(f"📊 Set new performance baseline for {test_name}: {execution_time:.3f}s")
