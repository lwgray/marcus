...
class PipelineTrackedProjectCreator:
    ...
    def __init__(self, kanban_client, ai_engine, pipeline_visualizer: SharedPipelineVisualizer, 
        ...
        async def tracked_analyze_prd(prd_content: str):
            ...
            try:
                ...
                self.bridge.log_ai_analysis_with_context(
                    ...
                    analysis_result={
                        "functionalRequirements": getattr(result, 'functional_requirements', []),
                        "nonFunctionalRequirements": getattr(result, 'non_functional_requirements', []),
        ...
        async def tracked_parse_prd(prd_content: str, constraints=None):
            ...
            self.pipeline_visualizer.add_event(
                ...
                data={
                    ...
                    "team_size": getattr(constraints, 'team_size', None) if constraints else None
                },
                status="in_progress"
            )
