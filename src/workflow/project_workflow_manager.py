...
class ProjectWorkflowManager:
    ...
    def __init__(self, marcus_client: SimpleMarcusClient, flow_manager: PipelineFlowManager):
    ...
    async def start_project_workflow(
        ...
        # Add workflow event
        self.flow_manager.add_event(flow_id, {
                        ...
                        if agents_result and 'agents' in agents_result:
                            ...
                            for agent in agents_to_use:
                                ...
                                if task_result and 'task' in task_result:
                                    ...
                                    self.flow_manager.add_event(workflow['flow_id'], {
                                        'type': 'task_assigned',
                                        'task_id': task['id'],
                                        'task_name': task['name'],
                                        'agent_id': agent['agent_id'],
