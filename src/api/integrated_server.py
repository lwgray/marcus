...
class IntegratedMarcusServer:
    ...
    def start_flask_server(self):
        ...
        def run_flask():
            ...
            socketio.run(app, host='0.0.0.0', port=self.web_port, debug=False, use_reloader=False, allow_unsafe_werkzeug=True)
...
def main():
    ...
    parser.add_argument('--no-web', action='store_true', 
                       help='Disable web UI (run MCP server only)')
