...
class Events:
    ...
    async def publish_nowait(self, event_type: str, source: str, data: Dict[str, Any], 
        ...
        Returns:
            The published Event object
        """
        return await self.publish(event_type, source, data, metadata, wait_for_handlers=False)
