...
echo "=========================================="
echo "UNICORN DEVELOPER 1"
echo "ID: agent_unicorn_1"
...
claude --add-dir /Users/lwgray/dev/marcus/experiments/dashboard-time-weather/implementation   --dangerously-skip-permissions < /Users/lwgray/dev/marcus/experiments/dashboard-time-weather/prompts/agent_unicorn_1.txt
echo ""
echo "=========================================="
echo "Unicorn Developer 1 - Work Complete"
echo "=========================================="
