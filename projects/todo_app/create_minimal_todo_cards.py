...
MINIMAL_CARDS = {
    ...
    "card-009": {"description": "Design the UI", "subtasks": ["Create mockups"]},
    "card-010": {
    ...
    "card-012": {"description": "Build add todo form", "subtasks": ["Create form"]},
    "card-013": {"description": "Create API service", "subtasks": ["Set up API calls"]},
    "card-014": {
        ...
        async with ClientSession(read, write) as session:
            ...
            for i, card_data in enumerate(TODO_APP_DATA["cards"]):
                ...
                try:
                    ...
                    if high_priority_label_id and "High Priority" in card_data.get(
                        "labels", []
                    ):
                        await session.call_tool(
